...
def seed_more_recipes():
    ...
    more_recipes_data = [
        ('Tomato Soup', 'James Bond', 'Vegetarian', '1 hour',
        ...
        ('Lamb Chops', 'Sherlock Holmes', 'Non-vegetarian', '2 hours',
        ...
        ('Quinoa Salad', 'Hermione Granger', 'Vegan', '30 minutes',
        ...
        ('BBQ Chicken', 'Harry Potter', 'Non-vegetarian', '1 hour 30 minutes',
        ...
        ('Pumpkin Soup', 'Ron Weasley', 'Vegan', '1 hour',
        ...
        ('Lemon Tart', 'Arya Stark', 'Vegetarian', '2 hours',
        ...
        ('Eggplant Parmesan', 'Jon Snow', 'Vegetarian', '2 hours 30 minutes',
